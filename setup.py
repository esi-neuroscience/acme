...
pipPkgs = ["sphinx_automodapi", "sphinx-tabs"]
...
ymlDict = {"name": "acme", "channels": ["conda-forge"], "dependencies": allPkgs}
header = (
    "#\n"
    + f"# Copyright © {datetime.datetime.now().strftime('%Y')} Ernst Strüngmann Institute (ESI) of the Max Planck Society\n#\n"
...
with open(citationFile, "w", encoding="utf8") as ymlFile:
    yaml.dump(ymlObj, ymlFile, allow_unicode=True)
