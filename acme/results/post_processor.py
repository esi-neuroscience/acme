...
class ResultPostProcessor:
    ...
    def process_futures(
        ...
        if write_worker_results:
            return self._process_file_results(
                futures, kwargv, result_shape, stacking_dim, self.results_dir
            )
    ...
    def _collect_in_memory(
        ...
        # Always log info for memory collection
    ...
    def _handle_multiple_files_results(
        ...
        return self._handle_normal_file_results(kwargv, values, payloadDir, result_shape, stacking_dim)
    ...
    def _add_missing_return_values(
        ...
        log.debug("Check if additional return values need to be added to container with pre-allocated dataset")
